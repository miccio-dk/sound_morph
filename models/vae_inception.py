...
class VaeInception(VaeBase):
    model_name = 'VaeInception'
    ...
    def __init__(self, configs):
        ...
        # Bottleneck
        self.fc_mu = nn.Linear(configs['dense_size'], configs['latent_size'])
        self.fc_logvar = nn.Linear(configs['dense_size'], configs['latent_size'])
        self.fc_rep = nn.Linear(configs['latent_size'], configs['dense_size'])
        # Decoder
